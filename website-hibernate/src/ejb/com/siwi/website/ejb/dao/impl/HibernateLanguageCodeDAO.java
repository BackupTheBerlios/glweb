/*
 * $Id: HibernateLanguageCodeDAO.java,v 1.1 2003/10/30 10:28:38 paxson Exp $
 * 
 */
...
import com.siwi.website.ejb.dao.LanguageCodeDAO;
 ...
 */
public class HibernateLanguageCodeDAO implements LanguageCodeDAO {
    
    private static final String ALL_LANGUAGECODES = "LanguageCode.findAll";

    public void init() throws DAOException {
        // TODO Auto-generated method stub
    }

    public long add(LanguageCode value) throws DAOException {
    ...
    public Collection findAll() throws DAOException {
        ...
        try {
            ...
            _query = _session.getNamedQuery(ALL_LANGUAGECODES);
    ...
    public LanguageCode get(long id) throws DAOException {
        Session _session = null;

        try {
            _session = HibernateUtil.retrieveDefaultSession();
            
            return (LanguageCode) _session.load(LanguageCode.class, new Long(id));
    ...
    public void update(LanguageCode value) throws DAOException {
        Session _session = null;
