<%--
 $Id: member_4.jsp,v 1.2 2003/06/12 05:52:46 paxson Exp $
 $Revision: 1.2 $
  ...
  <tr> 
    <td class="table4">
      <table width="100%" border="0" cellpadding="5" cellspacing="1" class="grey8">
        ...
        <tr> 
          <td height="26" colspan="2" class="table2"><font class="grey8">注意： 發表文章之前必須先註冊成會員。註冊請<a href="#" class="link1">按這裡註冊</a>。註冊是完全免費的！</font></td>
        </tr>
        <tr> 
          ...
          <td width="75%" class="table3">
            <input  name="field" size="40" value="" style="BORDER-RIGHT: #666666 1px solid; BORDER-TOP: #666666 1px solid; BORDER-LEFT: #666666 1px solid; BORDER-BOTTOM: #666666 1px solid" >
            不得超過 40 個中文字</td>
        </tr>
        <tr> 
        ...
        <tr> 
          ...
          <td class="table3">
            <INPUT CHECKED id=sig name=sig
            type=checkbox value=yes>
            是否顯示您的簽名？</td>
        </tr>
        <tr> 
          <td colspan="2" align="center" class="table3"><a href="#"><img src="../image/new-topic.gif" width="95" height="21" border="0"></a>　<a href="#"><img src="../image/preview.gif" width="58" height="21" border="0"></a>　<a href="#"><img src="../image/clear.gif" width="58" height="21" border="0"></a></td>
        </tr>
      </table>
    </td>
  </tr>
